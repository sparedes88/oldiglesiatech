...
export class ContactCategoryFormComponent implements OnInit {
  ...
  onRegister() {
    ...
    if (this.category) {
      ...
      subscription = this.api.post(`users/categories/updateMemberCategory`, payload);
    } else {
      ...
      subscription = this.api.post(`users/categories/insertMemberCategory`, payload);
    }

...
@Component({
  ...
  templateUrl: './time-sheet-home.component.html',
  styleUrls: ['./time-sheet-home.component.scss']
})
export class TimeSheetHomeComponent implements OnInit {
  ...
  initTimeSheet(time_sheet_form: TimeSheetFormComponent) {
    time_sheet_form.timesheet = new TimeSheetModel();
    time_sheet_form.ngOnInit();
  }

...
@Component({
  selector: 'app-public-design-note-form',
  templateUrl: './public-design-note-form.component.html',
  styleUrls: ['./public-design-note-form.component.scss']
})
export class PublicDesignNoteFormComponent implements OnInit {

...
@Component({
  selector: 'app-design-request-planning',
  templateUrl: './design-request-planning.component.html',
  styleUrls: ['./design-request-planning.component.scss']
})
export class DesignRequestPlanningComponent implements OnInit {
  ...
  @ViewChild('design_detail') design_detail: DesignRequestDetailComponent;

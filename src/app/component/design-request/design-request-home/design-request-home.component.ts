...
@Component({
  selector: 'app-design-request-home',
  templateUrl: './design-request-home.component.html',
  styleUrls: ['./design-request-home.component.scss']
})
export class DesignRequestHomeComponent implements OnInit {
  ...
  load(prevent_trigger?: boolean) {
    console.log(prevent_trigger);
    const promises: Promise<any>[] = [];
    promises.push(this.getStatuses());
    Promise.all(promises).then(async (response: any) => {
